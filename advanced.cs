...
namespace FBConsole
{
    ...
    class Program
    {
        ...
        static async void ListenToAdd()
        {
            // requires FireSharp 2+
            await firebaseClient.ListenAsync("Customer", (sender, args, z) => { Console.WriteLine($"Data changed at Path {args.Path} Data : {args.Data}"); });
        }
